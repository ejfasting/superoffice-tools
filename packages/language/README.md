...
- [src/crmscript.langium](src/crmscript.langium) -  The grammar definition of your language
- [src/crmscript-module.ts](src/crmscript-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/crmscript-validator.ts](src/crmscript-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/crmscript.monarch.ts](src/syntaxes/crmscript.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/crmscript.tmLanguage.json](syntaxes/crmscript.tmLanguage.json) - Textmate based syntax highlighting instructions.
