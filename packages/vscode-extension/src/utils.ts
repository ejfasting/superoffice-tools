...
export function getPackagePublisher(context: ExtensionContext): string {
  const publisher = context.extension.packageJSON.publisher as string;
  return publisher;
}

/**
 * All courtesy of this code goes to estruyf:
 * https://github.com/estruyf/vscode-auth-sample/blob/main/src/util.ts
 *  */
